...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Space VS Evil Space", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Space VS Evil Space", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "JoaTH Team";
		app.meta["file"] = "Space VS Evil Space";
		app.meta["name"] = "Space VS Evil Space";
		...
		#elseif air
		app.window.title = "Space VS Evil Space";
		#else
